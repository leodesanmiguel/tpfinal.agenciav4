                    ...
                    <div class="col-md-12 col-md-offset-0 text-center">
                        <div class="row row-mt-15em">
                            ...
                            <div class="col-md-12 mt-text animate-box" data-animate-effect="fadeInUp">
                                <h1>Paquetes de viajes con todas las posibilidades</h1>
                            </div>
            ...
            <div class="gtco-container">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2 text-center gtco-heading">
                        <h2>Elija El Mejor Paquete <br>Para Usted</h2>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="price-box">
                            <h2 class="pricing-plan">Básico</h2>
                            <div class="price"><sup class="currency">$</sup>370<small>/pq</small></div>
                            <p>Paquete Básico para viajes de negocios o escapada turística</p>
                            <hr>
                    ...
                    <div class="col-md-4">
                        <div class="price-box">
                            ...
                            <div class="price"><sup class="currency">$</sup>590<small>/pq</small></div>
                            <p>Viaje de Negocios o escapada turística con traslados y eventos</p>
                            <hr>
                            <ul class="pricing-info">
                                <li>Hoteles 4*</li>
                                <li>Libres Bus y Metro</li>
                                <li>Avion I/V</li>
                                <li>2 Eventos</li>
                                <li>. </li>
                                <li>. </li>
                    ...
                    <div class="col-md-4">
                        <div class="price-box popular">
                            ...
                            <div class="price"><sup class="currency">$</sup>979<small>/pq</small></div>
                            <p>Viaje de Negocios o Escapada con eventos y rutas turísticas</p>
                            <hr>
                            <ul class="pricing-info">
                                <li>Destinos Internacionales</li>
                                <li>Hoteles 4* y 5*</li>
                                <li>Vehículo en Aeropuerto </li>
                                <li>Avión I/V</li>
                                <li>4 Eventos</li>
                                <li>2 Rutas</li>
                            </ul>
                            <a href="#" class="btn btn-primary btn-sm">Empezar</a>
                        </div>
                    </div>
                </div>
            </div>
