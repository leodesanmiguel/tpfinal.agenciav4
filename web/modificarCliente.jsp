...
<html lang="es">
    ...
    <body>
        ...
        <%
            ...
            Cliente c = (Cliente) request.getSession().getAttribute("clienteOk");
                                ...
                                <div class="col-lg-6">
                                    <div class="card-body p-md-5 mx-md-4">
                                        ...
                                        <div class="text-center">
                                            ...
                                            <h4 class="mt-1 mb-5 pb-1">MODIFICAR UN CLIENTE</h4>
                                        </div>
                                        <% if (c != null) {
                                                String no = c.getNombreP();
                                                //out.println("el cliente es ta bien... " 
                                                //        + c.getApellidoP()+c.getDni());
                                        %>
                                        <form action="SvEditarClie"  method="POST">
                                            <p>Datos del Cliente</p>
                                            <div class="form-outline mb-4">
                                                <input type="text" id="frmDNI1" name="frmDNI1" 
                                                       class="form-control" value="<%=c.getDni()%>" disabled />
                                                <input type="hidden" id="frmDNI" name="frmDNI" 
                                                       class="form-control" value="<%=c.getDni()%>" />
                                            ...
                                            <div class="form-outline mb-4">
                                                <input type="text" id="frmApellido" name="frmApellido" 
                                                       class="form-control" value="<%=c.getApellidoP()%>" />
                                                <label class="form-label" for="forApellido">Apellido</label>
                                            </div>
                                            <div class="form-outline mb-4">
                                                <input type="text" id="frmDomicilio" name="frmDomicilio" 
                                                       class="form-control" value="<%=c.getDireccionP()%>" />
                                                <label class="form-label" for="frmDomicilio">Domicilio</label>
                                            </div>
                                            <div class="form-outline mb-4">
                                                <%
                                                    SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy");
                                                    String fe = sdf.format(c.getFechaNacio());
                                                %>
                                                <input type="text" id="frmFechaN" name="frmFechaN" 
                                                       class="form-control" value="<%=fe%>" />
                                                <label class="form-label" for="frmNacional">Fecha de Nacimiento </label>
                                            </div>
                                            <div class="form-outline mb-4">
                                                <input type="text" id="frmNacional" name="frmNacional" 
                                                       class="form-control" value="<%=c.getNacionalidad()%>" />
                                                <label class="form-label" for="frmNacional">Nacionalidad </label>
                                            </div>
                                            <div class="form-outline mb-4">
                                                <input type="text" id="frmCelular" name="frmCelular" 
                                                       class="form-control" value="<%=c.getCelular()%>" />
                                                <label class="form-label" for="frmCelular">Celular </label>
                                            </div>
                                            <div class="form-outline mb-4">
                                                <input type="email" id="frmEmail" name="frmEmail" 
